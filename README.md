...
[![Last Updated](https://img.shields.io/badge/Updated-2026-08-27%2016%3A42%3A55-blueviolet.svg?style=flat-square)]()
...
| 32 | [**Create: Copper and Zinc** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-copper-zinc) | `create_copper_and_zinc` | `create_copper_and_zinc-2.0.0-forge-1.20.1.jar` | 0.09 MB | This mod adds recipes for Asurine and Veridium, providing a renewable source of Copper and Zinc to the player. |
| 33 | [**Create Enchantment Industry** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-enchantment-industry) | `create_enchantment_industry` | `create_enchantment_industry-1.4.1-for-create-6.0.8.jar` | 0.48 MB |  |
| 34 | [**Create Jetpack** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-jetpack) | `create_jetpack` | `create_jetpack-forge-4.4.6.jar` | 0.61 MB |  |
| 35 | [**Create: Netherless** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-netherless) | `create_netherless` | `create_netherless-2.0.0-1.20.1.jar` | 0.03 MB | Adds recipes for nether ressources thanks to the Create mod! |
| 36 | [**Create: Power Loader** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-power-loader) | `create_power_loader` | `create_power_loader-2.0.3-mc1.20.1.jar` | 0.22 MB |  |
| 37 | [**Create** 🔗](https://www.curseforge.com/minecraft/mc-mods/create) | `create` | `create-1.20.1-6.0.8.jar` | 18.28 MB |  |
| 38 | [**Create Crafts & Additions** 🔗](https://www.curseforge.com/minecraft/mc-mods/createaddition) | `createaddition` | `createaddition-1.20.1-1.3.3.jar` | 1.5 MB |  |
| 39 | [**Create Goggles** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-goggles) | `creategoggles` | `creategoggles-1.20.1-6.1.1-FORGE.jar` | 0.37 MB |  |
| 40 | [**Create Stuff 'N Additions** 🔗](https://www.curseforge.com/minecraft/mc-mods/create-stuff-additions) | `create_sa` | `create-stuff-additions1.20.1_v2.1.2.jar` | 1.3 MB | Create Stuff & Additions is a mod that uses the resources of Create to offer a new set of equipment, tools and gadget! Equipmen... |
| 41 | [**CreateStuffAdditionsFix** 🔗](https://www.curseforge.com/minecraft/mc-mods/createstuffadditions-fix) | `createstuffadditionsfix` | `createstuffadditionsfix-forge-1.20.1-0.0.0.1.jar` | 0 MB |  |
| 42 | [**Cultural Delights** 🔗](https://www.curseforge.com/minecraft/mc-mods/cultural-delights) | `culturaldelights` | `culturaldelights-0.16.7.jar` | 0.25 MB |  |
| 43 | [**Curios API** 🔗](https://www.curseforge.com/minecraft/mc-mods/curios) | `curios` | `curios-forge-5.14.1+1.20.1.jar` | 0.38 MB |  |
| 44 | [**Default Skill Trees** 🔗](https://www.curseforge.com/minecraft/mc-mods/default-skill-trees) | `default_skill_trees` | `default_skill_trees-1.1.jar` | 0.01 MB | Adds default skill trees for Pufferfish's Skills mod. |
| 45 | [**Delightful** 🔗](https://www.curseforge.com/minecraft/mc-mods/delightful) | `delightful` | `Delightful-1.20.1-3.8.1.jar` | 1.69 MB | Farmer's Delight addon with mod compatibility features and fun new foods. |
| 46 | [**Drink Beer Refill** 🔗](https://www.curseforge.com/minecraft/mc-mods/drink-beer-refill) | `drinkbeer` | `drinkbeer-refill-1.20.1-1.0.5.jar` | 1.45 MB | Add placeable beer mug and drink it! |
| 47 | [**Embeddium** 🔗](https://www.curseforge.com/minecraft/mc-mods/embeddium) | `embeddium` | `embeddium-0.3.31+mc1.20.1.jar` | 1.26 MB |  |
| 48 | [**Enchanting Infuser** 🔗](https://www.curseforge.com/minecraft/mc-mods/enchanting-infuser) | `enchantinginfuser` | `EnchantingInfuser-v8.0.3-1.20.1-Forge.jar` | 0.17 MB | An all new enchanting table: Choose your enchantments for fair prices! Plus no more randomness! |
| 49 | [**End's Delight** 🔗](https://www.curseforge.com/minecraft/mc-mods/ends-delight) | `ends_delight` | `ends_delight-2.6+forge.1.20.1.jar` | 0.26 MB |  |
| 50 | [**ExpandAbility** 🔗](https://www.curseforge.com/minecraft/mc-mods/expandability) | `expandability` | `expandability-forge-9.0.4.jar` | 0.08 MB |  |
...
- **마지막 업데이트 일시:** 2026-08-27 16:42:55 (KST)